 ...
 * @author bluez
 */
public class Form_Sum2Numbers extends javax.swing.JFrame {

    /**
     * Creates new form Form_Sum2Numbers
     */
    public Form_Sum2Numbers() {
        initComponents();
        this.jLabelPHEPCONG.setFont(new Font("Arial",Font.PLAIN,30));
        this.setTitle("Phép Cộng");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_Sum2Numbers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_Sum2Numbers().setVisible(true);
            }
        });
    }
